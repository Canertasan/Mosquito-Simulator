...
def load_images_to_cubemap_texture(
    ...
    first_cubemap_texture_position = gl.GL_TEXTURE_CUBE_MAP_POSITIVE_X
    ...
    gl.glTexParameterf(gl.GL_TEXTURE_CUBE_MAP, gl.GL_TEXTURE_WRAP_R, gl.GL_CLAMP_TO_EDGE)
    gl.glTexParameterf(gl.GL_TEXTURE_CUBE_MAP, gl.GL_TEXTURE_MAG_FILTER, mag_filter)
    gl.glTexParameterf(gl.GL_TEXTURE_CUBE_MAP, gl.GL_TEXTURE_MIN_FILTER, min_filter)
